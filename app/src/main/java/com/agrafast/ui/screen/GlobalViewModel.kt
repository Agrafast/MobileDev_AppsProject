...
class GlobalViewModel @Inject constructor(
  ...
  fun fetchPredictionPlants(): List<Plant> {
    return listOf(
      ...
      Plant(name = "rice", title = "Padi", botanical_name = "Oryza sativa", image_url = "https://firebasestorage.googleapis.com/v0/b/plant-tutorials/o/banner%2Frice.webp?alt=media&token=80f2c70a-ced8-4989-b652-6b2f29c1be14&_gl=1*zsova*_ga*MzUwOTU2NjU3LjE2ODMyMTE3Mjc.*_ga_CW55HF8NVT*MTY4NTk3ODkyMC4xOS4xLjE2ODU5ODA2ODIuMC4wLjA.").addId("dasr9Kae7uQhYc1GWwhC"),
    )
  }
